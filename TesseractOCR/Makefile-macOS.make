...
# TODO: libtiff-ios -> libtiff-macos?
...
# TODO: iphoneos-version-min
common_cflags = -L$(LIB_FAT_DIR) -Qunused-arguments -arch $(call swap, $*, $(arch_names_all), $(archs_all)) -pipe -no-cpp-precomp -isysroot $$SDKROOT -miphoneos-version-min=$(MACOS_DEPLOY_TGT) -O2
