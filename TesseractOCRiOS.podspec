Pod::Spec.new do |s|
  ...
  s.name                    = 'TesseractOCRiOSPDF'
  s.version                 = '4.0.0'

  s.summary                 = 'Use Tesseract OCR in iOS projects written in either Objective-C or Swift.'

  s.homepage                = 'https://github.com/mihailsalari/Tesseract-OCR-iOS'
  s.documentation_url       = 'https://github.com/mihailsalari/Tesseract-OCR-iOS/blob/master/README.md'
